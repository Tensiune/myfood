        ...
        <Card className="rounded-[2.5rem] border-4 border-brand-accent shadow-2xl bg-white overflow-hidden animate-in zoom-in-95 duration-300">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button className="flex-2 h-16 rounded-2xl bg-green-600 hover:bg-green-700 text-white font-black text-xl shadow-xl shadow-green-100 active:scale-95 transition-all" onClick={handleAccept}>ACEITAR AGORA</Button>
            </div>
          </CardContent>
        </Card>
      ) : (
